...
% Manuscript fragment: the complete regression-results tabular. Slope intervals
% are 95% wild bootstrap CIs over acquisition blocks, in bold where the interval
% excludes zero. Intervals are written as plain text: \num and math mode both
% drop \textbf
